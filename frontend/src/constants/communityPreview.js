/** Shared Social Media & Community Preview CMS shape for PhysioAtHome and TeleRehab. */
...
export const HOME_COMMUNITY_DEFAULTS = {
  ...
  community_image_desktop: '',
  community_image_tablet: '',
};
...
export function communityImageValue(value) {
