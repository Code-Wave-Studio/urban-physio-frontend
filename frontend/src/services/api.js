...
export const admin = {
  ...
  seoCheckUrl: (params) => api.get('/admin/seo/check-url', { params }),
  seoGenerateUrl: (data) => api.post('/admin/seo/generate-url', data),
  ...
  orgLogosSettings: () => api.get('/admin/org-logos-settings'),
  updateOrgLogosSettings: (data) => api.put('/admin/org-logos-settings', data),
...
export const clinicPortal = {
  ...
  patientExerciseFeedback: (clinicId, patientKey, params) =>
    api.get(`/clinic-portal/${clinicId}/patients/${patientKey}/exercise-feedback`, { params }),
  updateExerciseFeedback: (clinicId, logId, data) =>
    api.put(`/clinic-portal/${clinicId}/exercise-feedback/${logId}`, data),
  convertFeedbackToClinicalNote: (clinicId, logId) =>
...
export const erpAssessments = {
  ...
  deleteResponse: (id, params) => api.delete(`/erp/assessments/responses/${id}`, { params }),
  uploadDocument: (id, params) => api.post(`/erp/assessments/responses/${id}/upload-document`, {}, { params }),
