  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'modal-pop': 'modalPop 0.18s cubic-bezier(0.16, 1, 0.3, 1) forwards',
      ...
      keyframes: {
        ...
        modalPop: { '0%': { opacity: '0', transform: 'translateY(12px) scale(0.98)' }, '100%': { opacity: '1', transform: 'translateY(0) scale(1)' } },
